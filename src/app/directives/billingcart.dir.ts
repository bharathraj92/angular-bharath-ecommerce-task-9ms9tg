...
@Component({
  ...
  <h4 class="d-flex justify-content-between align-items-center mb-3">
          ...
          <ul class="list-group mb-3">
            ...
            >
              <div>
                <h6 class="black">{{itm.name}} -   <span class="badge badge-pill badge-info text-right">{{itm.qty}}  Nos</span> x <span class="badge badge-pill badge-default text-right">{{itm.price/itm.qty}}  </span></h6>                
              </div>
